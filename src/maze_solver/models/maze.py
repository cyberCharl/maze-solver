...
# Maze is a collection of Squares. Immutable to allow hashing & caching
...
class Maze:
    ...
    # Allows maze instance to cooperate with for loops (Iterable)
    def __iter__(self) -> Iterator[Square]:
        return iter(self.squares)

    # Enables square bracket notation on maze object (Subscriptable)
